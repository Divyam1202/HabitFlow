...
export default function AdminSettingsPage() {
  ...
  const { user } = useAuth()
  const isSuperAdmin =
    user?.email === 'habytflow@gmail.com' || user?.role === 'SUPER_ADMIN'
    ...
    <div className="p-6 md:p-10 space-y-8 animate-in fade-in duration-500 max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between font-sans">
          <div>
            ...
            <p className="text-xs text-zinc-500">
              Choose between light off-beige, cosmic dark, or system matching.
            </p>
          </div>
      ...
      <div className="border border-border bg-card p-6 text-card-foreground space-y-6">
        ...
        >
          {passwordMessage && (
            <div
              className={`p-4 text-xs font-bold uppercase tracking-wider border ${
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 pr-11 border border-border bg-background text-foreground text-sm focus:outline-none focus:border-foreground"
                  required
                />
      ...
      <form onSubmit={handleSubmit} className="space-y-8 font-sans">
        {!isSuperAdmin && (
          <div className="border border-red-500/20 bg-red-500/10 text-red-500 p-4 text-xs font-bold tracking-widest uppercase flex items-center gap-2">
            <ShieldAlert size={16} />
            Global Site configuration parameters are restricted to Super
            Admins.
          </div>
        )}
        ...
        {/* General */}
        <div
          className={`border border-border bg-card p-6 text-card-foreground space-y-6 ${
            !isSuperAdmin ? 'opacity-50 pointer-events-none' : ''
          }`}
        >
          <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-500 flex items-center gap-2">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-500">
                  Toggle whether new user registrations are permitted.
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-zinc-500">
                  Enable to lock the application for updates and maintenance.
                </p>
              </div>
